          ...
          <CarouselContent>
            {galleryItems.map((item) => (
              <CarouselItem key={item.id} className="flex flex-col items-center">
                 <div
                   className="relative w-full max-w-[270px] md:max-w-sm h-[405px] md:h-[500px] rounded-3xl overflow-hidden shadow-2xl bg-white cursor-pointer transition-all duration-300 hover:scale-105 mx-auto touch-manipulation"
