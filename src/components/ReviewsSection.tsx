  ...
  const getReviews = () => {
    const baseReviews = {
      fr: [{
        ...
        avatar: 'N',
        rating: 5,
        comment: "J'ai confié mes tapis à MonHygiène et je suis extrêmement satisfait du résultat. Ils sont revenus comme neufs, propres, parfumés et bien traités. Le service est professionnel, rapide et très soigné. Je recommande vivement MonHygiène à tous ceux qui veulent un nettoyage de qualité !"
      }, {
        id: 3,
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 md:mb-20">
          <h2 className="text-4xl md:text-5xl lg:text-7xl font-bold text-foreground mb-6 md:mb-8 tracking-tight">
            {t('reviews.title')} <span className="bg-gradient-to-r from-primary to-blue-400 bg-clip-text text-transparent">avis</span>
          </h2>
        ...
        <div className="relative max-w-4xl mx-auto mb-12 md:mb-16">
          <div className="flex items-center justify-center space-x-2 md:space-x-4">
            <Button variant="outline" size="icon" onClick={prevSlide} className="rounded-full w-10 h-10 md:w-14 md:h-14 shadow-xl hover:shadow-2xl transition-all duration-300 border-2 hover:border-primary">
              <ChevronLeft className="h-5 w-5 md:h-7 md:w-7" />
            </Button>

            <div className="w-full max-w-2xl">
              <div className="bg-white rounded-3xl shadow-2xl p-6 md:p-12 border-2 border-primary/10 transition-all duration-700">
                <div className="text-center">
                  <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-gradient-to-br from-primary to-primary/80 flex items-center justify-center text-white font-bold text-2xl md:text-3xl shadow-lg mx-auto mb-4 md:mb-6">
                    {currentReview.avatar}
                  </div>
                  
                  <h3 className="font-bold text-foreground text-lg md:text-2xl mb-2 md:mb-3">{currentReview.name}</h3>
                  
                  <div className="flex justify-center space-x-1 mb-4 md:mb-6">
                    {renderStars(currentReview.rating)}
                  </div>
                  
                  <p className="text-gray-800 leading-relaxed text-sm md:text-xl italic font-medium">
            ...
            <Button variant="outline" size="icon" onClick={nextSlide} className="rounded-full w-10 h-10 md:w-14 md:h-14 shadow-xl hover:shadow-2xl transition-all duration-300 border-2 hover:border-primary">
