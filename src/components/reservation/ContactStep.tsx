...
export const ContactStep = ({ draft, onContactUpdate, onSubmit, onBack }: ContactStepProps) => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row justify-between gap-4 pt-2 sm:pt-4 mb-8">
        <Button
          variant="outline"
          onClick={onBack}
          className="px-6 py-3 text-base sm:text-lg rounded-2xl order-2 sm:order-1"
        >
          Retour
        </Button>
        ...
        <Button
          ...
          className="bg-primary hover:bg-primary/90 text-white px-6 py-3 text-base sm:text-lg rounded-2xl disabled:opacity-50 order-1 sm:order-2"
        >
          {loading ? (
            <>
