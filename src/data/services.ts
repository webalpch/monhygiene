...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    icon: 'Armchair',
    description: 'Nettoyage de canapé à domicile avec tarifs selon nombre de places'
  },
  {
  ...
  },
  {
    ...
    icon: 'Armchair',
    description: 'Shampooinage des sièges de véhicule'
  },
  {
    id: 'nettoyage-moquette-tapis',
    name: 'Nettoyage moquettes/tapis',
    icon: 'Layers',
    description: 'Nettoyage de moquettes et tapis sur devis'
  },
  {
    id: 'nettoyage-vitres',
  ...
  },
  {
    ...
    icon: 'CircleDot',
    description: 'Nettoyage du tapis de votre table de billard'
  },
  {
